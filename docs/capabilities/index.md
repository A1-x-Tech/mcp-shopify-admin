...
- [Создать товар](./create-product.md) — Создаёт товар с дефолтным вариантом; по умолчанию статус ACTIVE — товар сразу на витрине. **Воздействие:** изменяет данные.
...
- [Список клиентов](./list-customers.md) — Возвращает страницу клиентов (имя, email, телефон, число заказов, потраченная сумма) плюс общий count. **Воздействие:** только чтение.
